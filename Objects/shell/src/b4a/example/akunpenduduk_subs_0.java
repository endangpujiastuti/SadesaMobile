...
try {
		Debug.PushSubsStack("Activity_Pause (akunpenduduk) ","akunpenduduk",8,akunpenduduk.mostCurrent.activityBA,akunpenduduk.mostCurrent,46);
...
try {
		Debug.PushSubsStack("Activity_Resume (akunpenduduk) ","akunpenduduk",8,akunpenduduk.mostCurrent.activityBA,akunpenduduk.mostCurrent,42);
...
try {
		Debug.PushSubsStack("btnadd_Click (akunpenduduk) ","akunpenduduk",8,akunpenduduk.mostCurrent.activityBA,akunpenduduk.mostCurrent,84);
...
try {
		Debug.PushSubsStack("btnBack_Click (akunpenduduk) ","akunpenduduk",8,akunpenduduk.mostCurrent.activityBA,akunpenduduk.mostCurrent,89);
...
try {
		Debug.PushSubsStack("btnSave_Click (akunpenduduk) ","akunpenduduk",8,akunpenduduk.mostCurrent.activityBA,akunpenduduk.mostCurrent,100);
...
try {
		Debug.PushSubsStack("FilterList (akunpenduduk) ","akunpenduduk",8,akunpenduduk.mostCurrent.activityBA,akunpenduduk.mostCurrent,70);
...
try {
		Debug.PushSubsStack("isiSpinner (akunpenduduk) ","akunpenduduk",8,akunpenduduk.mostCurrent.activityBA,akunpenduduk.mostCurrent,95);
...
akunpenduduk.mostCurrent._spnnik.runVoidMethod ("Clear");
 BA.debugLineNum = 97;BA.debugLine="spnnik.AddAll(Array As String(\"Data 1\",\"Data 2\",\"";
Debug.ShouldStop(1);
akunpenduduk.mostCurrent._spnnik.runVoidMethod ("AddAll",(Object)(akunpenduduk.mostCurrent.__c.runMethod(false, "ArrayToList", (Object)(RemoteObject.createNewArray("String",new int[] {4},new Object[] {BA.ObjectToString("Data 1"),BA.ObjectToString("Data 2"),BA.ObjectToString("Data 3"),RemoteObject.createImmutable("Data 4")})))));
...
try {
		Debug.PushSubsStack("search_EnterPressed (akunpenduduk) ","akunpenduduk",8,akunpenduduk.mostCurrent.activityBA,akunpenduduk.mostCurrent,51);
...
try {
		Debug.PushSubsStack("showList (akunpenduduk) ","akunpenduduk",8,akunpenduduk.mostCurrent.activityBA,akunpenduduk.mostCurrent,56);
