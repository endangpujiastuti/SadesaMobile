...
try {
		Debug.PushSubsStack("Activity_Create (datapenduduk) ","datapenduduk",7,datapenduduk.mostCurrent.activityBA,datapenduduk.mostCurrent,21);
...
try {
		Debug.PushSubsStack("Activity_Pause (datapenduduk) ","datapenduduk",7,datapenduduk.mostCurrent.activityBA,datapenduduk.mostCurrent,34);
...
try {
		Debug.PushSubsStack("Activity_Resume (datapenduduk) ","datapenduduk",7,datapenduduk.mostCurrent.activityBA,datapenduduk.mostCurrent,30);
...
try {
		Debug.PushSubsStack("btnTambah_Click (datapenduduk) ","datapenduduk",7,datapenduduk.mostCurrent.activityBA,datapenduduk.mostCurrent,40);
...
try {
		Debug.PushSubsStack("showList (datapenduduk) ","datapenduduk",7,datapenduduk.mostCurrent.activityBA,datapenduduk.mostCurrent,44);
if (RapidSub.canDelegate("showlist")) { return b4a.example.datapenduduk.remoteMe.runUserSub(false, "datapenduduk","showlist");}
int _i = 0;
 BA.debugLineNum = 44;BA.debugLine="Sub showList";
Debug.ShouldStop(2048);
 BA.debugLineNum = 45;BA.debugLine="ModulKoneksi.koneksi";
Debug.ShouldStop(4096);
datapenduduk.mostCurrent._modulkoneksi.runVoidMethod ("_koneksi" /*RemoteObject*/ ,datapenduduk.mostCurrent.activityBA);
 BA.debugLineNum = 47;BA.debugLine="Lv.Clear";
Debug.ShouldStop(16384);
datapenduduk.mostCurrent._lv.runVoidMethod ("Clear");
 BA.debugLineNum = 48;BA.debugLine="ModulKoneksi.rs = ModulKoneksi.mh.Query(\"SELECT *";
...
datapenduduk.mostCurrent._modulkoneksi._rs /*RemoteObject*/  = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("mysql.mysqlhandler.ResultSetWrapper"), datapenduduk.mostCurrent._modulkoneksi._mh /*RemoteObject*/ .runMethod(false,"Query",(Object)(RemoteObject.createImmutable("SELECT * FROM tb_penduduk ORDER BY no_kk ASC"))));
 BA.debugLineNum = 50;BA.debugLine="For i = 0 To ModulKoneksi.rs.RowCount - 1";
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 51;BA.debugLine="ModulKoneksi.rs.Position  = i";
Debug.ShouldStop(262144);
datapenduduk.mostCurrent._modulkoneksi._rs /*RemoteObject*/ .runMethod(true,"setPosition",BA.numberCast(int.class, _i));
 BA.debugLineNum = 52;BA.debugLine="Lv.AddTwoLines(ModulKoneksi.rs.GetString2(\"no_kk";
...
;
 BA.debugLineNum = 55;BA.debugLine="ModulKoneksi.mh.Close";
Debug.ShouldStop(4194304);
