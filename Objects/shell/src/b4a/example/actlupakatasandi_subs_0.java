...
try {
		Debug.PushSubsStack("Activity_Create (actlupakatasandi) ","actlupakatasandi",9,actlupakatasandi.mostCurrent.activityBA,actlupakatasandi.mostCurrent,19);
...
try {
		Debug.PushSubsStack("Activity_Pause (actlupakatasandi) ","actlupakatasandi",9,actlupakatasandi.mostCurrent.activityBA,actlupakatasandi.mostCurrent,28);
...
try {
		Debug.PushSubsStack("Activity_Resume (actlupakatasandi) ","actlupakatasandi",9,actlupakatasandi.mostCurrent.activityBA,actlupakatasandi.mostCurrent,24);
...
try {
		Debug.PushSubsStack("BtnHubAdmin_Click (actlupakatasandi) ","actlupakatasandi",9,actlupakatasandi.mostCurrent.activityBA,actlupakatasandi.mostCurrent,32);
